          ...
          <div class="max-w-sm mx-auto bg-white rounded-xl overflow-hidden md:max-w-lg">
            <div class="md:flex">
              ...
              <div class="p-5">
                ...
                <a class="block mt-1 text-lg font-medium text-pretty text-center hover:text-sky-600" href="#">
                  The nature is very beautiful and it also looks preety.
                </a>
                <p class="mt-1 text-sm text-balance text-center text-slate-500">
                  <span class="bg-yellow-200 rounded-lg p-1 font-bold md:bg-yellow-800 md:text-black">Lorem ipsum</span>dolor sit amet consectetur adipisicing elit. Saepe
                  tempora aliquam asperiores tempore harum laborum laboriosam
                  aut reiciendis perspiciatis ducimus?
                </p>
              </div>
            </div>
          </div>
