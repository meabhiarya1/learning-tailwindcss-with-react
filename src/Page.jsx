...
const Page = () => {
  return (
    <div class="bg-slate-950 h-screen size-full">
      <div class="bg-slate-950 h-screen">
        ...
        <div class="h-10 w-full flex flex-col items-center mt-10">
          ...
          <div class="w-60 bg-yellow-600 h-1 m-3 rounded-sm md:w-60"></div>
        </div>
        <div class=" bg-slate-950 h-100 w-full flex items-center text-center p-5 flex-nowrap justify-evenly">
          <div class="w-24 flex flex-col items-center justify-center mx-4 my-2">
            <img
              class="w-34 h-10"
              src="https://d2bps9p1kiy4ka.cloudfront.net/5b09189f7285894d9130ccd0/65d1e4cb-abf8-4bda-9f2c-49f37a714b7a.webp"
            />
          ...
          <div class="w-24 flex flex-col items-center justify-center mx-4 my-2">
            <img
              ...
              src="https://d2bps9p1kiy4ka.cloudfront.net/5b09189f7285894d9130ccd0/65d1e4cb-abf8-4bda-9f2c-49f37a714b7a.webp"
            />
            <p class="text-white font-bold text-xl m-1">400 +</p>
            <p class="text-white text-sm text-nowrap text-center font-semibold">
              Batches for You!
            </p>
          </div>
